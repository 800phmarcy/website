      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6 order-1 align-self-end">
            <img src="<?php echo(IMAGES.'model_4.png'); ?>" alt="Image" class="img-fluid">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="custom-border-bottom py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="<?php echo site_url(getUrl(array("c" => "home", "m" => "index"))); ?>">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Shop</strong></div>
        </div>
      </div>
    </div>
            ...
            <div class="row mb-5">
              ...
              <div class="col-lg-4 col-md-4 item-entry mb-4">
                <a href="#" class="product-item md-height bg-gray d-block">
                  <img src="<?php echo(IMAGES.'sample.png'); ?>" alt="Image" class="img-fluid">
                </a>
              ...
              <div class="col-lg-4 col-md-4 item-entry mb-4">
                <a href="#" class="product-item md-height bg-gray d-block">
                  <img src="<?php echo(IMAGES.'sample-2.png'); ?>" alt="Image" class="img-fluid">
                </a>
        ...
        <div class="row align-items-stretch">
          ...
          <div class="col-lg-4">
            ...
            <div class="product-item sm-height bg-gray">
              ...
              <img src="<?php echo(IMAGES.'model_6.png'); ?>" alt="Image" class="img-fluid">
            </div>
          </div>
        </div>
      </div>
